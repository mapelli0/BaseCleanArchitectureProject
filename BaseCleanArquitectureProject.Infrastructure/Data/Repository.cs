...
namespace BaseCleanArquitectureProject.Infrastructure.Data {
	...
	public class Repository<T, TKey>: IRepository<T, TKey> where T: BaseEntityId<TKey> {
		protected readonly BaseCleanArquitectureProjectDbContext _dbContext;
		...
		public Repository(BaseCleanArquitectureProjectDbContext dbContext, IMapper autoMapper, IValidator<T> validator) {
