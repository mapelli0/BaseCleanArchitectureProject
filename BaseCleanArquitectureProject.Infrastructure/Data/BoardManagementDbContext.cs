...
namespace BaseCleanArquitectureProject.Infrastructure.Data {
	...
	public class BaseCleanArquitectureProjectDbContext: IdentityDbContext<ApplicationUser, ApplicationRole, Guid> {
		private readonly IMediator _dispatcher;

		public BaseCleanArquitectureProjectDbContext (DbContextOptions<BaseCleanArquitectureProjectDbContext> options, IMediator dispatcher): base(options) {
